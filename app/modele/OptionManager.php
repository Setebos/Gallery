...
class OptionManager {
    ...
    public function getOption($id) {
     ...
     public function updateOption(Image $option) {
        $q = $this->_db->prepare('UPDATE option SET show_entire_gallery = :show_entire_gallery, diaporama_width = :diaporama_width, nb_images_per_line = :nb_images_per_line, display_duration = :display_duration WHERE id = :id');
